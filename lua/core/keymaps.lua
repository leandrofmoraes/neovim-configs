...
map('n', '<leader>e', function()
  Snacks.explorer(require('plugins.snacks.explorer'))
end, { desc = 'Explorer' })
...
map('n', ';<Tab>B', function()
  require('bufferline').move_to(1)
end, { desc = 'Move to beginning' })
map('n', ';<Tab>E', function()
  require('bufferline').move_to(-1)
end, { desc = 'Move to end' })

for i = 1, 9 do
  map('n', ';<Tab>' .. i, function()
...
map('n', '<leader>r', '<Cmd>nohlsearch<Bar>diffupdate<Bar>normal! <C-L><CR>', { desc = 'Clear & Refresh' })
