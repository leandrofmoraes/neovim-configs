  ...
  config = function()
    ...
    fzf.setup({
      ...
      oldfiles = {
        ...
        -- No Telescope, quando eu usava <leader>fr, ele carregava buffers antigos.
        -- O fzf-lua faz o mesmo, mas por padrão, buffers visitados na sessão atual
        -- não são incluídos. Eu uso <leader>fr o tempo todo para voltar aos buffers em que estava. Se você sentiu falta disso no Telescope,
        -- experimente.
