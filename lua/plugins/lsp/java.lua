        ...
        full_cmd = function(opts)
          ...
          if project_name then
            vim.list_extend(cmd, {
              ...
              "--jvm-arg=-Xbootclasspath/a:" .. home_dir .. "/.local/share/nvim/mason/packages/jdtls/lombok.jar",
              -- "--jvm-arg=-javaagent:" .. os.getenv('HOME') .. "/.m2/repository/org/projectlombok/lombok/1.18.30/lombok-1.18.30.jar",
              -- "-jar" .. os.getenv('HOME') .. "/.local/share/nvim/mason/share/jdtls/plugins/org.eclipse.equinox.launcher.jar",
              "-jar",
